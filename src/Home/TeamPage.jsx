    ...
    <div className="team-page bg-white">
      <header className="header">
        <h1 className='team-heading'>
          <img src="/images/mark.webp" alt='mark' className='mark' width={35} height={35}/>
      ...
      <section className="team-members">
        <div className="team-card sairam">
          <img src="/images/sairam.webp" alt="Uppugundla Sairam" className="profile-pic" width="150" 
            height="150"/>
        ...
        <div className="team-card saketh">
          <img src="/images/saketh.webp" alt="Kallepu Saketh Reddy" className="profile-pic" width="150" 
           height="150"/>
      ...
      <section className="description">
        ...
        <ul>
          <li>
          <img src="/images/tick-mark.webp" alt="tickMark" className='tick-mark' width="20" 
          height="20"/>
