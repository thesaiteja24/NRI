  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div className="bg-white w-11/12 md:w-2/3 lg:w-1/2 max-h-[90vh] overflow-y-auto p-6 rounded-lg shadow-lg">
        ...
        <p className="mb-2 text-lg">Please read carefully and agree to the below:</p>
        <ul className="list-disc ml-6 space-y-2 text-lg text-gray-700">
          <li>
            For the best experience, it is recommended to attempt coding problems on a
            larger screen.
          </li>
          <li>
            Ensure you load the latest version of Google Chrome (v60+) or the latest
            version of Firefox.
          </li>
          <li>
          ...
          <li>
            Set your system clock to IST (India Standard Time) to avoid any time mismatch.
          </li>
          <li>No tab switches are allowed during the test. Switching tabs may auto-submit.</li>
          <li>
            Any notifications or pop-ups during the test will be counted as a tab switch.
            Please ensure they are turned off.
          </li>
          <li>
            The test will automatically submit when the time limit is reached. Any unanswered
