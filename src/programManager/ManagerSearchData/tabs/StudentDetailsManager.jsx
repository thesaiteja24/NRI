...
const StudentDetailsManager = ({ data, profile }) => {
  if (!data) {
    return (
      <div className="w-full min-h-[60vh] flex flex-col items-center justify-center text-center p-6">
        ...
        />
        <p className="text-xl font-semibold text-gray-600 mb-1">No Student Data</p>
  ...
  return (
    <div className="flex flex-col xl:flex-row items-start w-full p-4 bg-white rounded-lg font-[inter] gap-8 xl:gap-12">
      ...
      <div className="w-full xl:w-[35%] mt-10 flex flex-col items-center justify-center">
        <div className="relative w-[120px] h-[120px] md:w-[150px] md:h-[150px] rounded-full overflow-hidden bg-gray-300 border">
          <img
      ...
      <div className="w-full xl:w-[65%] grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
        ...
        <div>
          <div className="flex items-center gap-3 mb-5">
            <div className="w-7 h-7 flex items-center justify-center bg-[#19216F] rounded-full">
              <MdPerson className="text-white text-lg" />
            </div>
            <h3 className="text-[#19216F] font-bold text-[18px]">
              Personal Information
            </h3>
          </div>
          <div className="space-y-3">
            {[
              ...
              >
                ...
                <span className="text-gray-600 break-words text-[13px]">{value}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-3">
            {[
              ...
              [
                'Skills',
                data.studentSkills?.length ? data.studentSkills.join(', ') : 'N/A',
              ],
            ].map(([label, value], idx) => (
              <div
                key={idx}
